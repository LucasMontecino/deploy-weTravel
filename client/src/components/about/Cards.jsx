    ...
    <div className="flex flex-wrap justify-center gap-4 font-medium">
      <div className="bg-white shadow-xl  w-80 rounded-3xl transition-all duration-500 ease-in-out px-2 ">
        ...
        <div className="flex justify-center items-center m-2">
          <a href="https://github.com/fahe8">
            <AiOutlineGithub className="h-8 w-8" />
          </a>
          <a href="<AiOutlineLinkedin/>">
      ...
      <div className="bg-white shadow-xl  w-80 rounded-3xl transition-all duration-500 ease-in-out px-2">
        ...
        <div className="m-2 text-left">
          ...
          <div>FullStack Developer</div>
          <div>Corrientes, Argentina</div>
        </div>

        <hr />
        <div className="flex justify-center items-center m-2">
          <a href="https://github.com/LucasMontecino">
            <AiOutlineGithub className="h-8 w-8" />
          </a>
          <a href="https://www.linkedin.com/in/lucasmontecino9">
            <AiOutlineLinkedin className="h-8 w-8" />
          </a>
        </div>
      </div>
      ...
      <div className="bg-white shadow-xl  w-80 rounded-3xl transition-all duration-500 ease-in-out px-2 ">
        ...
        <hr />
        <div className="flex justify-center items-center m-2">
          <a href="https://github.com/juan-rv">
            <AiOutlineGithub className="h-8 w-8" />
          </a>
      ...
      <div className="bg-white shadow-xl  w-80 rounded-3xl transition-all duration-500 ease-in-out px-2 ">
        ...
        <hr />
        <div className="flex justify-center items-center m-2">
          <a href="https://github.com/andradaalucas">
            <AiOutlineGithub className="h-8 w-8" />
          </a>
          <a href="https://www.linkedin.com/in/andradalucas/">
            <AiOutlineLinkedin className="h-8 w-8" />
          </a>
        </div>
      </div>
      ...
      <div className="bg-white shadow-xl  w-80 rounded-3xl transition-all duration-500 ease-in-out px-2">
        ...
        <div className="flex justify-center items-center m-2">
          ...
          <a href="https://www.linkedin.com/in/carolina-barragan-4a5022247">
            <AiOutlineLinkedin className="h-8 w-8" />
          </a>
        </div>
      </div>
      ...
      <div className="bg-white shadow-xl  w-80 rounded-3xl transition-all duration-500 ease-in-out px-2 ">
        ...
        <hr />
        <div className="flex justify-center items-center m-2">
          <a href="https://github.com/santiagogomezz">
            <AiOutlineGithub className="h-8 w-8" />
          </a>
          <a href="https://www.linkedin.com/in/santiago-gomez-410a52199/">
            <AiOutlineLinkedin className="h-8 w-8" />
          </a>
        </div>
      </div>
